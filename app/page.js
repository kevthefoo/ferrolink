        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <form className="mx-auto mb-8 max-w-md">
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <button
                type="submit"
                className="group transform rounded-lg bg-gradient-to-r from-orange-600 to-red-600 px-8 py-4 font-bold whitespace-nowrap text-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:from-orange-700 hover:to-red-700 hover:shadow-xl"
              >
