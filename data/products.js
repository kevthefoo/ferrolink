...
export const productsData = {
  "cnc-tools": {
    "carbide-end-mill-4flute": {
      ...
      technicalData: {
        "Recommended Speed (RPM)": "3000-8000 (aluminum), 1500-4000 (steel)",
  ...
  hammers: {
    "professional-claw-hammer": {
      ...
      relatedProducts: ["ball-peen-hammer-24oz", "demolition-sledgehammer"],
    },
    "ball-peen-hammer-24oz": {
      ...
      relatedProducts: ["professional-claw-hammer", "demolition-sledgehammer"],
    },
  },
  axes: {
    "felling-axe-36inch": {
