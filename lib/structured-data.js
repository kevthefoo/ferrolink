...
export const organizationSchema = {
  ...
  logo: "https://ferrolink.co/assets/logo/ferrolink-logo.png",
  description:
...
export const websiteSchema = {
  ...
  potentialAction: {
    ...
    target: {
      "@type": "EntryPoint",
      urlTemplate: "https://ferrolink.co/products?search={search_term_string}",
    },
...
export function generateProductSchema(
  ...
  return {
    ...
    url: `https://ferrolink.co/products/${categoryId}/${productId}`,
    image: product.mainImage
      ? [`https://ferrolink.co${product.mainImage}`]
      : [],
    offers: {
      "@type": "Offer",
